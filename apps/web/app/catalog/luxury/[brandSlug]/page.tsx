...
import { fetchLuxuryBrandProducts, fetchLuxuryBrands } from "../data";
...
export default async function LuxuryBrandPage({
  params,
}: {
  params: Promise<{ brandSlug: string }>;
}) {
  const { brandSlug } = await params;
  const [products, brands] = await Promise.all([fetchLuxuryBrandProducts(brandSlug), fetchLuxuryBrands()]);
